...
kmeans_threads_plot <- (
  ...
  + annotate("text", x=6, y=80000000, label="1 NUMA", size=3)
  + annotate("text", x=21, y=80000000, label="2 NUMA", size=3)
  + annotate("text", x=42, y=80000000, label="SMT", size=3)
...
regression_threads_plot <- (
  ...
  + geom_vline(xintercept=14)
  + geom_vline(xintercept=28)
  + annotate("text", x=6, y=5800000000, label="1 NUMA", size=3)
  + annotate("text", x=21, y=5800000000, label="2 NUMA", size=3)
  + annotate("text", x=42, y=5800000000, label="SMT", size=3)
